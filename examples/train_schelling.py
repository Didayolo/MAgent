...
if __name__ == "__main__":
    ...
    parser.add_argument("--name", type=str, default="schelling")
    ...
    # init the game
    env = magent.GridWorld("schelling", map_size=args.map_size)
    ...
    if args.alg == 'dqn':
        ...
        models.append(DeepQNetwork(env, handles[0], "schelling",
        ...
        models.append(DeepRecurrentQNetwork(env, handles[0], "schelling",
                                   learning_rate=3e-4,
