...
if __name__ == "__main__":
    ...
    parser.add_argument("--map_size", type=int, default=75)
    parser.add_argument("--greedy", action="store_true")
    parser.add_argument("--name", type=str, default="handshake")
    ...
    # init the game
    env = magent.GridWorld("handshake", map_size=args.map_size)
    env.set_render_dir("build/render/handshake")
    ...
    if args.alg == 'dqn':
        ...
        models.append(DeepQNetwork(env, handles[0], "handshake",
        ...
        models.append(DeepRecurrentQNetwork(env, handles[0], "handshake",
                                   learning_rate=3e-4,
