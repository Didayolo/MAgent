...
if __name__ == "__main__":
    ...
    parser.add_argument("--name", type=str, default="battle_regen")
    ...
    # init the game
    env = magent.GridWorld("battle_regen", map_size=args.map_size)
    ...
    if args.alg == 'dqn':
        ...
        models.append(DeepQNetwork(env, handles[0], "battle_regen",
        ...
        models.append(DeepRecurrentQNetwork(env, handles[0], "battle_regen",
                                   learning_rate=3e-4,
