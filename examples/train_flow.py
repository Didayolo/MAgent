...
if __name__ == "__main__":
    ...
    # init the game
    env = magent.GridWorld("flow", map_size=100)
    env.set_render_dir("build/render/flow")
    ...
    if args.alg == 'dqn':
        ...
        models.append(DeepQNetwork(env, handles[0], "flow",
        ...
        models.append(DeepRecurrentQNetwork(env, handles[0], "flow",
                                   learning_rate=3e-4,
