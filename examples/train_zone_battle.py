...
if __name__ == "__main__":
    ...
    parser.add_argument("--name", type=str, default="zone_battle")
    ...
    if args.alg == 'dqn':
        ...
        models.append(DeepQNetwork(env, handles[0], "zone_battle",
        ...
        models.append(DeepRecurrentQNetwork(env, handles[0], "zone_battle",
                                   learning_rate=3e-4,
